...
package com.turing.flink.log.springboot.starter.core;
...
public class ILogPrintAspect {
     ...
     * 打印类或方法上的 {@link ILog}
     */
    @Around("@within(com.turing.flink.log.springboot.starter.annotation.ILog) || @annotation(com.turing.flink.log.springboot.starter.annotation.ILog)")
